...
const CardFrameworkSettings = preload("res://addons/card-framework/card_framework_settings.gd")
const DropZone = preload("res://addons/card-framework/drop_zone.gd")
const Card = preload("res://addons/card-framework/card.gd")
const CardManager = preload("res://addons/card-framework/card_manager.gd")
const DraggableObject = preload("res://addons/card-framework/draggable_object.gd")
...
var unique_id: int
var drop_zone_scene = preload("res://addons/card-framework/drop_zone.tscn")
